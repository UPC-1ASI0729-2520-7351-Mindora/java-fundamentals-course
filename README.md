...
- Los conceptos esenciales de Java: variables, estructuras de control, funciones, clases y más.
- Cómo resolver problemas paso a paso usando lógica y buenas prácticas.
- Cómo trabajar en equipo y compartir tu código en línea.
...
- `scripts/`: Herramientas o utilidades extra (si aplica).
- `Markdown.md`: Detalles del curso, enlaces a videos y editores online.
...
4. Compara tu solución con la versión en `completed-examples`.
